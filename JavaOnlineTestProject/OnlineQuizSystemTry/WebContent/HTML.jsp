...
<div id="a1">
        ...
        <button class="btn navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
           ...
           <li class="nav"><h2 align="Center"><u>HTML MCQ Test</u></h2></li>   
...
<br><br><br>
<form name="test" method="post" action="EvaluateTest">
<div class='container'>

<%
Question[] ques= CodesterDAO.getQuestionsHTML();
int i=1;
for(Question q:ques){
%>
...
<div class='col-md-12'>
 ...
 <input type="radio" name="<%=i+"op3"%>"  >C. <%=q.getOption3() %><br>
   ...
   <input type="radio" name="<%=i+"op4"%>"  >D. <%=q.getOption4() %><br>
  <br>
  </div>
</div>
<%i++;} %>
